    ...
    <div className="h-auto px-6 md:px-16 lg:px-[162px] py-[80px] bg-white text-center">
      <div className="flex flex-col lg:flex-row justify-between items-center gap-8">
        <div className="w-full lg:w-[60%] text-left">
          <h1 className="font-bold font-mono text-[32px] md:text-[42px] leading-[42px]">A dedicated team to grow your company</h1>
          <p className="mt-2.5 mb-12 leading-5 text-[#333]">Lorem ipsum dolor sit amet consectetur adipiscing eli mattis sit phasellus mollis sit<br/>
          aliquam sit nullam neque ultrices.</p>
