export function DashboardWithoutImage() {
  return (
    <div className="h-auto bg-black py-6 px-4 sm:px-6 md:px-12 lg:px-[108px] lg:h-[426px] flex items-center justify-center">
      <div className="px-[325px] text-center">
        ...
        <div className="flex flex-wrap-4 justify-center">
          <button 
            className="flex items-center mr-7 h-[54px] text-white font-bold px-[38px] py-[17px] cursor-pointer border border-white bg-black hover:bg-white hover:text-black transition-all duration-300 ease-in-out">
              Get started
          </button>
